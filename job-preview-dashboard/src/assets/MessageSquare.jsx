...
function MessageSquare({isSelected}) {
  return (
        <div className='relative'>
        <svg className={`relative z-10 ${isSelected ? 'stroke-white z-20' : 'stroke-[#b0b0b0] group-hover:z-20 group-hover:stroke-orange'}`} width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <img className={`absolute top-0 right-0 ${isSelected ? 'z-10': 'group-hover:z-10 z-20'}`} src={reddot} alt="reddot" />
        </div>
